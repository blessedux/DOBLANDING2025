  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">DOB Protocol Wiki</h1>
        ...
        <div className="space-y-8">
          <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg shadow transition-colors duration-300">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Our Wiki section is currently under development. Please check back later for more information about DOB Protocol.
            </p>
          </div>
